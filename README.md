...
- [桥接模式(Bridge Pattern)](./21-bridge-pattern)---桥接模式是解决由于滥用面向对象语言的继承导致要加入新类型时出现的问题 https://blog.csdn.net/qq_31156277/article/details/80659537
...
- [命令模式(Command Pattern)](./23-command-pattern)  忘记写撤销操作了，参考https://blog.csdn.net/caroline_wendy/article/details/31419101
